...
#    Updated: 2021/03/23 23:29:11 by rosfryd          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
norm:
	norminette -R CheckForbiddenSourceHeader parser_utils_3.c parser_utils_1.c parser_utils_2.c mlx_utils_1.c mlx_utils_2.c parser.c main_parser.c parser_id.c ft_bmp.c sprite1.c mlx.c \
